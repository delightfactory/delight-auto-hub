                          ...
                          {[
                            ...
                            <div 
                              ...
                              className={`border rounded-lg p-3 cursor-pointer hover:border-red-500 transition-colors ${
                                formData.preferences.theme === theme.id ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-200 dark:border-gray-700'
                              }`}
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          {[
                            ...
                            <div 
                              key={lang.id}
                              className={`border rounded-lg p-3 cursor-pointer hover:border-red-500 transition-colors ${
                                formData.preferences.language === lang.id ? 'border-red-500 bg-red-50 dark:bg-red-900/20' : 'border-gray-200 dark:border-gray-700'
                              }`}
