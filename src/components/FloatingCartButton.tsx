  ...
  return (
    <>
      ...
      >
        ...
        {itemCount > 0 && (
          <motion.div
            className="absolute -top-2 -right-2 bg-delight-warning text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
        ...
        {isOpen && (
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
              ...
              >
                <SheetHeader className="p-3 border-b flex items-center justify-between bg-delight-secondary">
                  <SheetTitle className="flex items-center gap-2 text-white font-delight">
                    <ShoppingBag className="h-4 w-4 text-delight-orange" />
                    سلة المشتريات
                  </SheetTitle>
