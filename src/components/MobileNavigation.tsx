  ...
  return (
    <>
      ...
      <motion.nav
        ...
        className="fixed inset-x-0 bottom-0 h-16 w-full bg-white/90 dark:bg-gray-900/80 backdrop-blur-lg border-t border-white/30 dark:border-white/10 shadow-2xl rounded-t-2xl sm:hidden" 
        style={{ zIndex: 10000 }}
      >
        <ul className="flex items-center h-full w-full px-2">
          <li className="flex-1">
            <button 
              ...
              className="flex flex-col items-center justify-center gap-1 h-full w-full text-xs py-1 transition-all duration-150 ease-out transform hover:-translate-y-0.5 text-delight-600 dark:text-delight-400"
            >
          ...
          {navItems.slice(0, 3).map((item) => {
            ...
            return (
              <li key={item.name} className="flex-1">
                <Link 
                  to={item.path} 
                  className={`flex flex-col items-center justify-center gap-1 h-full w-full text-xs py-1 transition-all duration-150 ease-out transform hover:-translate-y-0.5 ${
                    isActive 
          ...
          <li className="flex-1 relative">
            <Link 
              to="/cart" 
              className="flex flex-col items-center justify-center gap-1 h-full w-full text-xs py-1 transition-all duration-150 ease-out transform hover:-translate-y-0.5 text-gray-500 dark:text-gray-400 hover:text-delight-600 dark:hover:text-delight-400"
            >
