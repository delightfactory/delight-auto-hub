...
const EnhancedFilterDialog: React.FC<EnhancedFilterDialogProps> = ({
  ...
  return (
    <Sheet>
      ...
      <SheetContent 
        side="right" 
        className="lg:hidden p-0 w-[75%] sm:max-w-[320px] border-l shadow-lg flex flex-col"
        style={{ height: '80vh', top: '50%', transform: 'translateY(-50%)' }}
      >
        <SheetHeader className="px-3 py-2 border-b bg-gray-50 dark:bg-gray-800 sticky top-0 z-10 flex flex-row justify-between items-center">
          <div className="flex items-center gap-1.5">
            <Filter className="h-4 w-4 text-delight-600" />
            <SheetTitle className="text-base font-semibold">الفلاتر</SheetTitle>
            {activeFiltersCount > 0 && (
